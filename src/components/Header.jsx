  ...
  return (
    <AppBar
      ...
      sx={{
        ...
        boxShadow: '0px 10px 30px rgba(209, 34, 34, 0.7)',
      ...
      >
        ...
        >
          <img
            ...
            onMouseEnter={(e) => {
              e.target.style.filter = 'drop-shadow(0px 4px 10px rgba(226, 30, 30, 0.7))';
            }}
            onMouseLeave={(e) => {
          ...
          <Button
            ...
            sx={{
              ...
              '&:hover': {
                ...
                transform: 'scale(1.1)',
                boxShadow: '0px 10px 20px rgba(252, 35, 35, 0.5)',
              },
            }}
          >
            {!isSmallScreen && 'Home'}
          ...
          <Button
            ...
            sx={{
              ...
              '&:hover': {
                color: theme.palette.primary.main,
                transform: 'scale(1.1)',
                boxShadow: '0px 10px 20px rgba(255, 107, 107, 0.5)',
              },
            }}
          >
